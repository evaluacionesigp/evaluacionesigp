...
import { initFormDraftAutosave, restoreFormDraft, applyDraftToForm } from './core/form-draft.js';
...
// reutiliza esas mismas opciones de escala. restoreFormDraft la llama irTest()
// al entrar a cada test; applyDraftToForm la llama aplicarEdicionResultado()
// como fallback genérico para los tests sin repoblado manual (ambas en
// legacy-tests.js).
Object.assign(window, {
  ...
  restoreFormDraft, applyDraftToForm,
});
